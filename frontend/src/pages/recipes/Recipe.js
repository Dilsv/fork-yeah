...
export const Recipe = (props) => {
    ...
    const { addedToList, setAddedToList, favouritesId, setFavouritesId } = useFetchFavourites(props);
            ...
            <Row className="justify-content-center align-items-center">
                ...
                <Col md={10} className="text-left mb-auto d-flex flex-column">
                    <div className="d-flex">
                        ...
                        <p className="text-muted ms-auto">{recipeDate ? `Created on : ${created_at}` : `Updated on ${updated_at}`}</p>
                    </div>
